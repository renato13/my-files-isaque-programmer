object frmGrContReceb: TfrmGrContReceb
  ...
  object ibdtstContRec: TIBDataSet
    ...
    object ibdtstContRecLkCliente: TStringField
      FieldKind = fkLookup
      FieldName = 'LkCliente'
      LookupDataSet = ibdtstClientes
    ...
    object ibdtstContRecNUMCONTRATO: TIBStringField
      FieldName = 'NUMCONTRATO'
      Origin = 'TBCONTREC.NUMCONTRATO'
      Size = 15
    end
    object ibdtstContRecPARCELA: TSmallintField
      FieldName = 'PARCELA'
      Origin = 'TBCONTREC.PARCELA'
    end
    object ibdtstContRecSTATUS: TIBStringField
      FieldName = 'STATUS'
  ...
  object ibdtstClientes: TIBDataSet
    Database = Dm.ibDtbsDVM
    Transaction = Dm.ibTrnsctnDVM
    BufferChunks = 1000
    CachedUpdates = False
