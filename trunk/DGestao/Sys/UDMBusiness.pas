...
const
  ...
  FUNCTION_USER_ID_GERENTE_ADM =  2;
  FUNCTION_USER_ID_GERENTE_VND =  3;
  FUNCTION_USER_ID_GERENTE_FIN =  4;
  FUNCTION_USER_ID_SUPERV_CX   =  5;
  FUNCTION_USER_ID_ESTOQUISTA  =  6;
  FUNCTION_USER_ID_CAIXA       =  7;
  FUNCTION_USER_ID_VENDEDOR    =  8;
  FUNCTION_USER_ID_AUX_FINANC1 =  9;
  FUNCTION_USER_ID_AUX_FINANC2 = 10;
