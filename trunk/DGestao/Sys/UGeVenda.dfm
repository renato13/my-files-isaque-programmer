  ...
  inherited IbUpdTabela: TIBUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into TBVENDAS'
        ...
        '   DTFINALIZACAO_VENDA, OBS, FORMAPAG, FATDIAS, SERIE, NFE, DATA' +
        'EMISSAO, '
      
        '   HORAEMISSAO, CFOP, VERIFICADOR_NFE, XML_NFE, VENDEDOR_COD, US' +
        'UARIO, '
      ...
      'values'
        ...
        '   :HORAEMISSAO, :CFOP, :VERIFICADOR_NFE, :XML_NFE, :VENDEDOR_CO' +
        'D, :USUARIO, '
      ...
      object bndMasterData: TfrxMasterData
        ...
        object Memo15: TfrxMemoView
          ...
          Memo.UTF8 = (
              ...
              '[FormatFloat('#39',0.00'#39',<frdItens."PFINAL">*<frdItens."DESCONTO">/1' +
              '00)] ')
          ParentFont = False
          WordWrap = False
          VAlign = vaCenter
