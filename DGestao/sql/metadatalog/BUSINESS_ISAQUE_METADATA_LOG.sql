...
/*------ SYSDBA 09/01/2013 10:10:10 --------*/

COMMENT ON COLUMN TBCOMPRAS.STATUS IS
'Status do movimento de entrada:
1 - Aberto
2 - Finalizado
3 - Cancelado
4 - NF-e Emitida';
...
/*------ SYSDBA 09/01/2013 10:18:53 --------*/

CREATE DOMAIN DMN_PERCENTUAL AS
DECIMAL(10,2)
DEFAULT 0;COMMENT ON DOMAIN DMN_PERCENTUAL IS 'Percentual de 0 a 100';




/*------ SYSDBA 09/01/2013 10:20:19 --------*/

ALTER TABLE TBCOMPRASITENS
    ADD ALIQUOTA DMN_PERCENTUAL,
    ADD ALIQUOTA_CSOSN DMN_PERCENTUAL,
    ADD ALIQUOTA_PIS DMN_PERCENTUAL,
    ADD ALIQUOTA_COFINS DMN_PERCENTUAL,
    ADD PERCENTUAL_REDUCAO_BC DMN_PERCENTUAL;

COMMENT ON COLUMN TBCOMPRASITENS.ALIQUOTA IS
'Percentual de 0 a 100';

COMMENT ON COLUMN TBCOMPRASITENS.ALIQUOTA_CSOSN IS
'Percentual de 0 a 100';

COMMENT ON COLUMN TBCOMPRASITENS.ALIQUOTA_PIS IS
'Percentual de 0 a 100';

COMMENT ON COLUMN TBCOMPRASITENS.ALIQUOTA_COFINS IS
'Percentual de 0 a 100';

COMMENT ON COLUMN TBCOMPRASITENS.PERCENTUAL_REDUCAO_BC IS
'Percentual de 0 a 100';




/*------ SYSDBA 09/01/2013 10:24:10 --------*/
...
/*------ SYSDBA 09/01/2013 10:24:47 --------*/

COMMENT ON COLUMN TBCOMPRASITENS.PERCENTUAL_REDUCAO_BC IS
'Percentual de reducao para Base de Calculo do ICMS.';




/*------ SYSDBA 09/01/2013 11:11:18 --------*/

CREATE TABLE TBUSERALLOW (
    FORM_NAME VARCHAR(250) CHARACTER SET ISO8859_2,
    OBJECT_NAME VARCHAR(50),
    CONSENTS_STRING DMN_TEXTO);

COMMENT ON COLUMN TBUSERALLOW.FORM_NAME IS
'Nome do formulario.';

COMMENT ON COLUMN TBUSERALLOW.OBJECT_NAME IS
'Nome do objeto TEvUserAccess no formulario.';

COMMENT ON COLUMN TBUSERALLOW.CONSENTS_STRING IS
'Conteudo da propriedade "Consents" do objeto TEvUserAccess.';




/*------ SYSDBA 09/01/2013 11:11:40 --------*/

update RDB$RELATION_FIELDS set
RDB$NULL_FLAG = 1
where (RDB$FIELD_NAME = 'FORM_NAME') and
(RDB$RELATION_NAME = 'TBUSERALLOW')
;
...
/*------ SYSDBA 09/01/2013 11:11:52 --------*/

ALTER TABLE TBUSERALLOW
ADD CONSTRAINT PK_TBUSERALLOW
PRIMARY KEY (FORM_NAME);

GRANT ALL ON TBUSERALLOW TO "PUBLIC";



/*------ SYSDBA 09/01/2013 11:31:37 --------*/

CREATE INDEX IDX_TBUSERALLOW
ON TBUSERALLOW (FORM_NAME,OBJECT_NAME);




/*------ SYSDBA 09/01/2013 12:01:00 --------*/
