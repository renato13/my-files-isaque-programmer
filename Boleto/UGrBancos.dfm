object frmGrBancos: TfrmGrBancos
  Left = 639
  Top = 298
  Width = 742
  Height = 440
  ...
  Caption = 'Tabela de Bancos para Gerar Boletos'
  Color = clBtnFace
  ...
  object IbDtstBanco: TIBDataSet
    ForcedRefresh = True
    BeforePost = IbDtstBancoBeforePost
    OnNewRecord = IbDtstBancoNewRecord
    BufferChunks = 1000
    CachedUpdates = False
    DeleteSQL.Strings = (
    ...
    InsertSQL.Strings = (
      'insert into TBCONTREC'
        ...
        '  (NUMLANC, CNPJ, TIPPAG, HISTORIC, NUMREC, DTEMISS, DTVENC, DTR' +
        'EC, DOCBAIX, '
      
        '   VALORREC, VALORMULTA, VALORRECTOT, NUMCONTRATO, PARCELA, STAT' +
        'US)'
      'values'
      
        '  (:NUMLANC, :CNPJ, :TIPPAG, :HISTORIC, :NUMREC, :DTEMISS, :DTVE' +
        'NC, :DTREC, '
      
        '   :DOCBAIX, :VALORREC, :VALORMULTA, :VALORRECTOT, :NUMCONTRATO,' +
        ' :PARCELA, '
      '   :STATUS)')
    RefreshSQL.Strings = (
      'Select '
    ...
    UpdateObject = IbUpdBanco
    Left = 656
    Top = 40
    object IbDtstBancoBCO_COD: TSmallintField
      Alignment = taCenter
      FieldName = 'BCO_COD'
  ...
  object DtSrcBanco: TDataSource
    AutoEdit = False
    DataSet = IbDtstBanco
    OnStateChange = DtSrcBancoStateChange
    Left = 688
    Top = 40
  end
  object IbUpdBanco: TIBUpdateSQL
    RefreshSQL.Strings = (
      'Select '
      '  BCO_COD,'
      '  BCO_CARTEIRA,'
