object frmGrRemessaBoleto: TfrmGrRemessaBoleto
  Left = 383
  Top = 160
  Width = 928
  Height = 480
  ...
  object pnlFiltro: TPanel
    ...
    object GroupBox1: TGroupBox
      ...
      object datInicio: TDateTimePicker
        Left = 272
        Top = 40
        Width = 97
        Height = 21
        ...
        TabOrder = 1
        OnChange = datInicioChange
      end
      object datFinal: TDateTimePicker
        Left = 376
        Top = 40
        Width = 97
        Height = 21
  ...
  object CdsTitulos: TClientDataSet
    ...
    Left = 112
    Top = 264
    object CdsTitulosNUMLANC: TLargeintField
      Alignment = taCenter
      FieldName = 'NUMLANC'
    ...
    object CdsTitulosCNPJ1: TStringField
      FieldName = 'CNPJ1'
      Required = True
      Size = 18
    end
